  ...
  return (
    <div className="flex flex-col min-h-screen bg-transparent text-zinc-300 font-sans">
      ...
      <section className="relative h-[calc(100vh-100px)] sm:h-[calc(100vh-80px)] min-h-[440px] sm:min-h-[500px] max-h-[850px] flex flex-col items-start justify-center pb-8 sm:pb-24 overflow-hidden px-3.5 sm:px-12 md:px-16 lg:px-24 text-left z-20">
        <div className="max-w-5xl w-full relative z-30 flex flex-row items-center justify-start gap-3 sm:gap-6 md:gap-8 flex-wrap sm:flex-nowrap -translate-y-[135%] sm:-translate-y-[15%]">
          ...
          <div className="diamond-btn-wrapper w-[185px] sm:w-[235px] md:w-[255px] h-[48px] sm:h-[52px] md:h-[56px] group shrink-0 relative z-30 my-1">
            <Link 
              to="/inventory" 
              className="diamond-btn-content text-[#D4AF37] hover:text-[#FCF6BA] font-bold tracking-[0.12em] sm:tracking-[0.15em] uppercase text-xs sm:text-sm md:text-[15px] font-serif px-5 sm:px-6 flex items-center justify-center leading-none text-center"
            >
              <span className="whitespace-nowrap leading-none pt-0.5">Browse Inventory</span>
            </Link>
          </div>
