                ...
                <div className="space-y-5 sm:space-y-6 text-zinc-300">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select 
                        className="w-full bg-zinc-950/80 border border-zinc-800 text-xs tracking-wider text-zinc-300 uppercase edgy-card-sm px-4 py-3.5 outline-none focus:border-[#D4AF37] transition-colors block shadow-sm font-serif cursor-pointer"
                        value={sortBy}
