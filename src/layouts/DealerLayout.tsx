      ...
      <div className="w-64 bg-zinc-900 border-r border-zinc-800 flex flex-col">
        <div className="p-6 border-b border-zinc-800">
          <Link to="/" className="flex flex-col items-start group">
            <span className="font-serif text-2xl tracking-wider text-white font-bold leading-none uppercase">AUTOSQUAD</span>
            <span className="font-sans text-[0.65rem] tracking-[0.35em] text-[#C8A64A] font-medium leading-tight uppercase font-mono">SHOWROOM</span>
          </Link>
